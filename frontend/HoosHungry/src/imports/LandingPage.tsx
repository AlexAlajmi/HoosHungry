...
export default function LandingPage({
  ...
  return (
    <div className="relative min-h-[1911px] w-full overflow-x-hidden bg-[#efefef]">
      <div className="absolute left-0 top-0 h-[80px] w-full bg-white" />
      <div className="absolute bottom-0 left-0 h-[138px] w-full bg-[#fd6500]" />
      <div
        className="relative left-1/2 h-[1911px] w-[1280px] -translate-x-1/2"
      ...
      <div className="absolute h-[345px] left-[382px] top-[360px] w-[517px]" data-name="landing page photo">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute inset-0 h-full max-w-none object-cover w-full" src={imgLandingPage} />
        </div>
      </div>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-none left-[534px] not-italic text-[#f50] text-[32px] top-[860px] whitespace-nowrap">How it works</p>
      ...
      <button
        ...
        className="absolute cursor-pointer h-[35px] left-[1071px] top-[27px] w-[150px]"
        onClick={onGetStarted}
        type="button"
      />
      <div className="absolute content-start flex flex-wrap font-['Inter:Bold',sans-serif] font-bold gap-[9px_10px] items-start leading-none left-[241px] not-italic top-[982px] w-[324px]">
      ...
      <div className="absolute font-['Inter:Bold',sans-serif] font-bold h-[126px] leading-none left-[714px] not-italic top-[1212px] w-[324px]">
      ...
      <div className="absolute h-[216px] left-[380px] top-[1166px] w-[179px]" data-name="burrito photo">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute inset-0 h-full max-w-none object-cover w-full" src={imgBurrito} />
        </div>
      </div>
      <div className="absolute content-start flex flex-wrap font-['Inter:Bold',sans-serif] font-bold gap-[9px_10px] items-start leading-none left-[255px] not-italic top-[1464px] w-[324px]">
      ...
      <div className="absolute h-[130px] left-[710px] top-[1445px] w-[314px]" data-name="sub photo">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute inset-0 h-full max-w-none object-cover w-full" src={imgSub} />
        </div>
      </div>
      <div className="absolute content-stretch flex flex-col h-[167px] items-start left-[800px] p-[10px] top-[952px] w-[212px]">
